...
function BonkDebugDrawPlane(_x, _y, _z, _xNormal, _yNormal, _zNormal, _color = BONK_DRAW_DEFAULT_DIFFUSE_COLOR)
{
    ...
    vertex_position_3d(_vertexBuffer, _a[0], _a[1], _a[2]); vertex_color(_vertexBuffer, _color, 1.0); vertex_normal(_vertexBuffer, _xNormal, _yNormal, _zNormal);
    vertex_position_3d(_vertexBuffer, _b[0], _b[1], _b[2]); vertex_color(_vertexBuffer, _color, 1.0); vertex_normal(_vertexBuffer, _xNormal, _yNormal, _zNormal);
    vertex_position_3d(_vertexBuffer, _d[0], _d[1], _d[2]); vertex_color(_vertexBuffer, _color, 1.0); vertex_normal(_vertexBuffer, _xNormal, _yNormal, _zNormal);
    
    vertex_position_3d(_vertexBuffer, _a[0], _a[1], _a[2]); vertex_color(_vertexBuffer, _color, 1.0); vertex_normal(_vertexBuffer, _xNormal, _yNormal, _zNormal);
    vertex_position_3d(_vertexBuffer, _d[0], _d[1], _d[2]); vertex_color(_vertexBuffer, _color, 1.0); vertex_normal(_vertexBuffer, _xNormal, _yNormal, _zNormal);
    vertex_position_3d(_vertexBuffer, _c[0], _c[1], _c[2]); vertex_color(_vertexBuffer, _color, 1.0); vertex_normal(_vertexBuffer, _xNormal, _yNormal, _zNormal);
