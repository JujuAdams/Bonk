...
function BonkCreateHeightmap(_function, _cellWidth, _cellHeight, _cellMinZ, _cellMaxZ, _x, _y, _z, _xScale, _yScale, _zScale, _object = BonkObject, _variableStruct = undefined, _groupVector = BONK_DEFAULT_GROUP)
{
    static _staticVariableStruct = {};
    
    with(instance_create_depth(0, 0, 0, _object, _variableStruct ?? _staticVariableStruct))
    {
        BonkSetupHeightmap(_function,   _cellWidth, _cellHeight, _cellMinZ, _cellMaxZ,   _x, _y, _z,   _xScale, _yScale, _zScale,   _groupVector);
        return self;
    }
}