...
/// Constructor that creates a Bonk quad as a struct rather than an instance. For further
/// information please refer to `BonkSetupQuad()` (though native GameMaker variables other than
