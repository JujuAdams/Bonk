...
function BonkCapsuleCollideFloorQuad(_capsule, _quad)
{
    ...
    var _trace = dot_product_3d(_quadX1 - _capsuleX, _quadY1 - _capsuleY, _quadZ1 - _capsuleZ, 0, 0, 1) / 1;
    ...
    if (_tempY*_edgeX - _tempX*_edgeY > 0)
    {
    ...
    var _tempZ = _refZ - _quadZ1;
        ...
        var _refToPlaneDist = dot_product_3d(_tempX, _tempY, _tempZ, 0, 0, 1);
            ...
            if (_tempY*_edgeX - _tempX*_edgeY > 0)
            {
                ...
                if (_tempY*_edgeX - _tempX*_edgeY > 0)
                {
                    ...
                    if (_refToPlaneDist == 0)
                    {
                        ...
                        var _pushLength = _capsuleRadius + _penDepth;
                    }
                    else
                    {
