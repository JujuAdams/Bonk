#macro BONK_VERSION  "5.0.3-alpha"
#macro BONK_DATE     "2026-09-09"
...
#macro BONK_TYPE_HEIGHTMAP  11

#macro BONK_NUMBER_OF_TYPES  12

#macro BONK_DEFLECT_NONE      0
#macro BONK_DEFLECT_SLIPPERY  1
#macro BONK_DEFLECT_GRIPPY    2

#macro BONK_TESSELATE_SIMPLE          0
#macro BONK_TESSELATE_FLIP            1
#macro BONK_TESSELATE_ALTERNATE       2
#macro BONK_TESSELATE_ALTERNATE_FLIP  3
