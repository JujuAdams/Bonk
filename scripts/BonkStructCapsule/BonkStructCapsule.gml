...
/// Constructor that creates a Bonk capsule as a struct rather than an instance. For further
/// information please refer to `BonkSetupCapsule()` (though native GameMaker variables other than
