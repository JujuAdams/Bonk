...
/// 
/// `.height`
///   **Read-only** variables that stores the height of the cylinder in the z-axis. You may read
///   this variable at any time but it must not be directly written to. Please use the method below
///   to change the height of the cylinder.
/// 
/// `.SetHeight([height]`
///   Method to set the height of the cylinder in the z-axis. If the parameter is set to `undefined`
///   then the existing height will be used.
/// 
/// `.radius`
///   **Read-only** variables that stores the radius of the cylinder in the xy-plane. You may read
///   this variable at any time but it must not be directly written to. Please use the method below
///   to change the height of the cylinder.
/// 
/// `.SetRadius([radius])`
///   Method to set the radius of the cylinder in the xy-plane. If a parameter is set to `undefined`
