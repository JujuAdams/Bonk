...
/// Pushes the subject instance out of any Bonk structs/instances that are found by iterating over
/// shapes found within the provided `objectOrArray` parameter.
/// 
