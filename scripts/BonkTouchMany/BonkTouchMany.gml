...
/// Returns an array of Bonk shapes that the subject instance touches by iterating over shapes
...
/// Bonk world. This means that you may get a mixture of Bonk structs and Bonk instances in the
/// returned array.
/// 
