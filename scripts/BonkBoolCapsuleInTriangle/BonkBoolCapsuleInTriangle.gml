...
function BonkBoolCapsuleInTriangle(_capsule, _triangle)
{
    ...
    else
    {
        ...
        var _t = dot_product_3d(_normalX, _normalY, _normalZ, _triX1 - _capsuleX, _triY1 - _capsuleY, _triZ1 - _capsuleZ) / abs(_normalZ);
