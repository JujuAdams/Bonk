...
pointArrayA = __BonkSupercover3D(lineA.x1, lineA.y1, lineA.z1,   lineA.x2, lineA.y2, lineA.z2);

show_debug_message(lineA);
show_debug_message(pointArrayA);

world = new BonkStructWorld(64, 64, 64);
world.AddShape(new BonkStructAAB(100, 100, 100, 64, 64, 64));
world.AddShape(new BonkStructAAB(room_width/2, room_height/2, -10,   room_width, room_height, 10));
